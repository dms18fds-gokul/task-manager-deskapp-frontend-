...
export default function DeleteMessageModal({ isOpen, onClose, onConfirm }) {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            {/* Modal Container */}
            <div className="bg-[#1E1F22] rounded-xl shadow-2xl w-full max-w-md border border-[#2B2D31] overflow-hidden transform transition-all animate-in zoom-in-95 duration-200">
                ...
                <div className="bg-gradient-to-r from-red-900/40 to-red-900/10 p-6 border-b border-red-500/10 flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-white leading-tight">Delete Message</h3>
                        <p className="text-red-200/70 text-sm mt-1">This action cannot be undone.</p>
                    </div>
