...
const TaskNode = ({ task, level, path, onChange, onDelete, employees }) => {
    return (
        <div
            className={`
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={() => onChange(path, 'add_subtask', null)}
                            title="Add Subtask"
                ...
                <div className="flex flex-col gap-3">
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:ring-1 focus:ring-indigo-500 focus:bg-white transition-all outline-none text-gray-800"
                        ...
                        <div className="w-full flex items-center gap-2 overflow-x-auto scrollbar-hide py-1">
                            {employees.map(emp => (
                                <button
                                    key={emp._id}
                                    type="button"
                                    onClick={() => onChange(path, 'assignee', emp._id)}
                    ...
                    <div className="space-y-1">
                        ...
                        <textarea
                            ...
                            className="w-full px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:ring-1 focus:ring-indigo-500 focus:bg-white transition-all outline-none text-gray-800 scrollbar-hide resize-y max-h-32"
                        ...
                        {task.subtasks.map((subtask, index) => (
                            <TaskNode
                                ...
                                onDelete={() => {
                                    ...
                                    onChange(path, 'subtasks', newSubtasks);
                                }}
                                employees={employees}
                            />
                        ))}
...
const EmployeeGroupTaskAssignment = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Basic Validation
        if (!formData.projectName || !taskTree.title || formData.department.length === 0) {
            alert("Project Name, Main Task Title, and Department are required!");
            return;
        }
        ...
        if (!navigator.onLine) {
            try {
                ...
                if (userStr) {
                    ...
                    offlinePayload.assignedBy = user.id || user._id; // Accommodating Employee ID structure
                }
                ...
                offlinePayload.taskTree = taskTree;
        ...
        if (userStr) {
            const user = JSON.parse(userStr);
            payload.append("assignedBy", user.id || user._id);
        }
        ...
        <div className="flex h-screen overflow-hidden bg-gray-50 font-sans relative">
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <main className="flex-1 p-6 overflow-y-auto">
                    <div className="max-w-5xl mx-auto bg-white rounded-[24px] shadow-sm ring-1 ring-gray-200 overflow-hidden">
                        <div className="p-10">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 border-b border-gray-100 pb-6 gap-4">
                                <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">Create New Group Task</h2>
...
export default EmployeeGroupTaskAssignment;
